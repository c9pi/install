...
compile_tmux(){
  ...
  patch -p1 < 0004-evutil_parse_sockaddr_port-fix-buffer-overflow.patch
  patch -p1 < 20d6d445.patch
  patch -p1 < build_with_no_undefined.patch
  patch -p1 < dh-autoreconf
  patch -p1 < openssl_1.1.patch
